...
class IATIActivityTransactionSplit:
    ...
    def __init__(
        ...
        self.recipient_region_code = recipient_region_code
        if iati_activity_transaction:
            ...
            self.recipient_region_code = iati_activity_transaction.recipient_region_code

    def get_as_json(self):
        return {
            "value": self.value,
            "recipient_country_code": self.recipient_country_code,
            "recipient_region_code": self.recipient_region_code,
